...
// Emoji / Mood selector (local para esta tela)
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitleText}>Como você está hoje?</Text>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            {selectedMood && (
              <Text style={styles.feedbackText}>
                Obrigado por compartilhar como você está. Que tal fazer uma
                pausa guiada?
              </Text>
            )}
          </View>
          ...
          <View style={styles.progressCard}>
            <View style={styles.progressHeader}>
              <Text style={styles.progressTitle}>Participação do Mês</Text>
            ...
            <Text style={styles.progressFeedback}>
              Ótimo trabalho! Continue participando das atividades.
            </Text>
          </View>
              ...
              {shortcuts.map((shortcut, index) => {
                ...
                return (
                  <TouchableOpacity key={index} style={styles.shortcutItem}>
                    ...
                    >
                      <Icon size={20} color={shortcut.iconColor} />
                    </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.availableList}>
              {availableActivities.map((activity, index) => (
                <TouchableOpacity key={index} style={styles.availableCard}>
                  <Text style={styles.availableTitle}>{activity}</Text>
